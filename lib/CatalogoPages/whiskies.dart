...
class ProductoWhiskies extends StatefulWidget {
  @override
  _ProductoWhiskiesState createState() => _ProductoWhiskiesState();
}

class _ProductoWhiskiesState extends State<ProductoWhiskies> {
  final CollectionReference _pedidosReference =
      FirebaseFirestore.instance.collection("Pedidos");
  final User _usercur = FirebaseAuth.instance.currentUser;
  final CollectionReference _whiskiesReference =
