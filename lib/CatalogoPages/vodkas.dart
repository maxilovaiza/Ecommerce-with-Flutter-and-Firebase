...
class ProductoVodka extends StatefulWidget {
  @override
  _ProductoVodkaState createState() => _ProductoVodkaState();
}

class _ProductoVodkaState extends State<ProductoVodka> {
  final CollectionReference _pedidosReference =
      FirebaseFirestore.instance.collection("Pedidos");
  final User _usercur = FirebaseAuth.instance.currentUser;
  final CollectionReference _vodkaReference =
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<QuerySnapshot>(
              future:
                  _vodkaReference.where('categoria', isEqualTo: "vodka").get(),
              builder: (context, snapshot) {
