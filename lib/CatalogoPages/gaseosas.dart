...
import 'file:///E:/Ecommerce/e_commerce/lib/DescPage/producto_page.dart';
...
class ProductoGaseosa extends StatefulWidget {
  @override
  _ProductoGaseosaState createState() => _ProductoGaseosaState();
}

class _ProductoGaseosaState extends State<ProductoGaseosa> {
  final CollectionReference _pedidosReference =
      FirebaseFirestore.instance.collection("Pedidos");
  final User _usercur = FirebaseAuth.instance.currentUser;
  final CollectionReference _gaseosaReference =
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<QuerySnapshot>(
              future: _gaseosaReference
                  .where('categoria', isEqualTo: "gaseosa")
                  .get(),
              builder: (context, snapshot) {
