...
class ProductoVinos extends StatefulWidget {
  @override
  _ProductoVinosState createState() => _ProductoVinosState();
}

class _ProductoVinosState extends State<ProductoVinos> {
  final CollectionReference _pedidosReference =
      FirebaseFirestore.instance.collection("Pedidos");
  final User _usercur = FirebaseAuth.instance.currentUser;
  final CollectionReference _vinoReference =
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<QuerySnapshot>(
              future:
                  _vinoReference.where('categoria', isEqualTo: "vino").get(),
              builder: (context, snapshot) {
